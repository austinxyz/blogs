...
Example:
```
feat: add investment analysis drill-down feature

- Add account-level analysis for investment categories
- Implement monthly trend charts
...
- **Username**: austinxyz
- **Repository**: https://github.com/austinxyz/blogs.git
- **Branch**: main
...
- Source code: `*.tsx`, `*.ts`, `*.js`, `*.jsx`, `*.css`
- Blog posts: `blog/**/*.md`
- Pages: `src/pages/**/*`
- Configuration: `docusaurus.config.ts`, `*.json`, `*.yaml`, `*.yml`
