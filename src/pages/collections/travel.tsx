...
export default function Travel(): JSX.Element {
  ...
  const filteredPosts = allPosts.filter((post: any) =>
    post.metadata.tags.some((tag: any) => tag.label === 'travel')
  );

  return (
    <Layout
      title="Travel"
      description="Adventures, experiences, and stories from around the world.">
      <main className="container margin-vert--lg">
        <div className="row">
          <div className="col col--8 col--offset-2">
            <h1>Travel</h1>
            <p className="margin-bottom--lg">
              Adventures, experiences, and stories from around the world.
            </p>
